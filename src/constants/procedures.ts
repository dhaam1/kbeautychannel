    ...
    features: [
      {
        ...
        description: '강력한 고주파 에너지를 피부 진피층까지 정교하게 전달하여 탄력을 극대화합니다.',
        icon: '/images/thermage_icon_1.png',
      },
      {
        number: '02',
        title: 'Collagen Boost',
        description: '고주파 열에너지가 새로운 콜라겐 생성을 촉진하여 피부 환경을 근본적으로 개선합니다.',
        icon: '/images/thermage_icon_2.png',
      },
      {
        number: '03',
        title: 'Custom Design',
        description: '개개인의 얼굴 윤곽과 피부 두께를 고려한 1:1 맞춤형 샷 디자인을 적용합니다.',
        icon: '/images/thermage_icon_3.png',
      },
      {
        number: '04',
        title: 'Comfort Pulse',
        description: '진동 및 쿨링 시스템을 통해 통증을 최소화하고 편안한 시술 경험을 제공합니다.',
        icon: '/images/thermage_icon_4.png',
      },
      {
        number: '05',
        title: 'V-Line Lifting',
        description: '처진 턱선과 심부볼 부위를 집중 케어하여 매끄러운 V라인을 완성합니다.',
        icon: '/images/thermage_icon_1.png',
      },
      {
        number: '06',
        title: 'Texture Refining',
        description: '탄력 개선뿐만 아니라 거친 피부 결을 매끄럽게 다듬어주는 효과를 제공합니다.',
        icon: '/images/thermage_icon_2.png',
      },
      {
        number: '07',
        title: 'Long-lasting',
        description: '단 한 번의 시술로도 오랜 시간 유지되는 강력한 리프팅 효과를 경험할 수 있습니다.',
        icon: '/images/thermage_icon_3.png',
      },
      {
        number: '08',
        title: 'Natural Glow',
        description: '피부 본연의 광채를 되찾아주어 생기 있고 건강해 보이는 피부로 가꾸어 줍니다.',
        icon: '/images/thermage_icon_4.png',
      },
      {
        number: '09',
        title: 'Safe Tech',
        description: 'FDA와 KFDA의 승인을 받은 정품 장비와 팁만을 사용하여 안전을 보장합니다.',
        icon: '/images/thermage_icon_1.png',
      },
    ],
    ctaLink: '/contact',
