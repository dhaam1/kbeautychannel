    ...
    features: [
      ...
      },
      {
        ...
        qna: [
          ...
          { q: '통증이 있나요?', a: '사파이어 쿨링 시스템 덕분에 통증 부담이 적어 마취를 생략하고도 비교적 편안하게 받을 수 있는 시술입니다.' },
      ...
      },
      {
        ...
        qna: [
          { q: '온다 리프팅의 원리는 무엇인가요?', a: '특수 마이크로파(Microwave)를 사용하여 피부 표면 손상 부담을 줄이며 깊은 층에 에너지를 전달, 지방 분해와 탄력 개선을 유도하는 시술입니다.' },
          { q: '통증은 어떤가요?', a: '피부 표면은 차갑게 유지하면서 속으로만 열을 전달하므로 통증 부담이 비교적 적은 것이 특징입니다.' },
    ...
    features: [
      {
        ...
        title: '쥬베룩',
        enTitle: 'Juvelook',
        description: '자가 콜라겐 생성을 유도하여 자연스러운 볼륨과 결 개선을 돕습니다. 고분자 PLA와 히알루론산의 결합으로 깊게 패인 흉터와 넓은 모공 개선을 도우며, 자연스러운 피부 재생 효과를 기대할 수 있습니다.',
        icon: '/images/thermage_icon_1.png',
      ...
      },
      {
        ...
        description: '연어 주사로 알려진 PN 성분으로 피부 속 환경 개선을 돕습니다. 피부 장벽과 유수분 밸런스 회복을 도와 민감한 피부를 건강하게 가꾸는 데 도움을 줍니다.',
        icon: '/images/thermage_icon_2.png',
    ...
    features: [
      {
        ...
        qna: [
          { q: 'LDM 관리의 원리는 무엇인가요?', a: '고밀도 초음파가 세포의 진동을 유도하여 피부 장벽을 강화하고 수분 균형을 맞추며 재생 단백질 활성화에 도움을 주어 피부 건강 회복을 돕습니다.' },
          { q: '통증과 일상 복귀는 어떤가요?', a: '통증 부담이 거의 없으며 즉시 일상생활이 가능합니다. 중요한 약속 전날이나 당일 관리로도 적합합니다.' },
