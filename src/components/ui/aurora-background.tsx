...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative flex flex-col items-center justify-center bg-zinc-50 text-slate-950 dark:bg-white",
        className,
      )}
      {...props}
    >
