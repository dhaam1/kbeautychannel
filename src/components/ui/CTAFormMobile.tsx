...
export default function CTAFormMobile({
  formData,
  isChecked,
  isLoading,
  onInputChange,
  ...
  return (
    <div
      className="relative xl-custom:hidden w-full max-w-[528px] mx-auto bg-white overflow-hidden flex flex-col"
      style={{
        height: '594px',
    ...
    >
      ...
      >
        <div className="absolute top-[28px] left-1/2 -translate-x-1/2" style={{ width: '109.436px', height: '23.607px' }}>
          <svg xmlns="http://www.w3.org/2000/svg" width="110" height="24" viewBox="0 0 110 24" fill="none" style={{ width: '100%', height: '100%' }}>
        ...
        <p
          className={cn(
            ...
            isEn ? "w-[90%] top-[58px] text-[20px] tracking-[1.5px] whitespace-nowrap" : 
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-2 mt-2">
            <div
              ...
              className={`w-5 h-5 mt-0.5 rounded border flex-shrink-0 flex items-center justify-center transition-colors cursor-pointer ${isChecked ? 'bg-black border-black' : 'bg-[#F4F7FE] border-[#2B2B2B]'
                }`}
            >
              {isChecked && (
