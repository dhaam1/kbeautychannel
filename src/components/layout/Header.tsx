...
export default function Header() {
  ...
  return (
    <header 
      className={`fixed top-0 left-0 w-full z-[9999] transition-all duration-300 px-[5%] ${
        isScrolled 
          ? 'bg-white/80 backdrop-blur-xl py-4 border-b border-gray-100/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)]' 
