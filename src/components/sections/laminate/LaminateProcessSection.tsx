...
const InfoLabelRow = ({ text, tag }: { text: string; tag: 'h2' | 'p' }) => {
  const Tag = tag;
  return (
    <div className="flex min-w-[211px] w-fit h-[38px] justify-center px-4 items-center gap-[5px] border border-white">
...
export function LaminateProcessSection() {
  const t = useTranslations('solution.laminate.process');
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            src="/assets/laminate/laminate-2.webp"
        ...
        >
          <div className="relative flex flex-col items-start w-[300px] md:w-[342px]">
            ...
            <motion.p
              className="text-[28px] font-medium leading-normal tracking-[-0.28px] text-left pb-[86px] whitespace-pre-line"
              style={{
                color: '#262626',
              }}
              {...titleMotion}
