...
export function WhiteningCustomerSection_JP() {
            ...
            >
                ...
                >
                    <Image
                        ...
                        alt="ブランシュ·ホワイト ホームケアホワイトニング製品、歯科ホワイトニング後の効果の維持を助ける美白歯磨き粉"
                        fill
                ...
                >
                    <div className="relative flex flex-col items-start w-full max-w-[500px] overflow-visible whitespace-normal">
                        ...
                        <div className="flex justify-start mb-[10px] overflow-visible">
                            <InfoLabelRow text="ホームケアホワイトニング" tag="h2" />
                        </div>
                        ...
                        >
                            ブランシュ歯科は、オフィスホワイトニング治療にとどまらず、ホワイトニング効果を長く、健康的に維持できるよう、歯科医療専門家が設計したホームケアソリューションをご提案しています。
                        </p>
                        ...
                        <ul className="flex flex-col gap-[12px] md:gap-[16px] list-none pl-0 overflow-visible">
                            <li className="flex items-start overflow-visible">
                                ...
                                >
                                    歯に刺激を与える成分は使用せず、高性能な自然由来成分で歯茎と歯をしっかり保護します。
                                </p>
                            </li>
                            <li className="flex items-start overflow-visible">
                                <span className="mr-[8px] mt-[6px] text-black">•</span>
                                ...
                                >
                                    ソウル大学研究チームと共同開発した精密配合で口腔内環境を改善します。
                                </p>
                            </li>
                            <li className="flex items-start overflow-visible">
                                <span className="mr-[8px] mt-[6px] text-black">•</span>
                                ...
                                >
                                    天然由来の界面活性剤により、口内の乾燥を防ぎ、口臭の原因までしっかり除去します。
                                </p>
                            </li>
                        </ul>
