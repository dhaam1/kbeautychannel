 ...
 * 치아미백 대표원장 섹션 (일본어)
 */
export function WhiteningDirectorSection_JP() {
                    ...
                    >
                        ...
                        <Div
                            className={cn(
                                "text-left",
                                "text-[#000] font-['Pretendard']",
                                "text-[28px]", "font-medium", "leading-[40px]", "tracking-[-0.28px]"
                            )}
                            {...(motionEnabled ? fadeUp({ delay: 0.2 }) : {})}
                        >
                            ホワイトニングの分野で<br />
                            ソウル大学校修士号を取得した、<br />
                            ホワイトニング専門家が直接施術いたします。
                        </Div>
                    ...
                    >
                        ...
                        <div className="flex flex-row items-end justify-start w-full lg:w-auto gap-0 mt-8 flex-nowrap">
                            ...
                            <div className="text-left font-['Pretendard'] text-[14px] text-gray-500 leading-tight whitespace-pre-line flex-shrink-0">
                                ...
                                ニューヨーク・コロンビア大学{'\n'}
                                UCLA歯科病院研修{'\n'}
                                <span className="text-black font-semibold mt-1 block h-[20px] flex items-center">キム・テヒョン院長</span>
                            </div>
