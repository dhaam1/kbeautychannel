...
export default function LineCTASection() {
  return (
    <div className="relative w-full flex justify-center">
      <div className="bg-white rounded-2xl shadow-[0_4px_30px_0_rgba(0,0,0,0.1)] overflow-hidden border border-gray-100 w-full md:w-[460px] flex flex-col">
        {/* SVG Logo Icon (Blanche) + Mint Header */}
        <div className="bg-[#66CBC3] h-[120px] shrink-0 relative text-center">
          ...
          <div className="absolute top-[65px] left-1/2 -translate-x-1/2 text-white font-pretendard text-[20px] font-light tracking-[2px] whitespace-nowrap">
            LINEで無料相談
          </div>
        </div>

        {/* Content area */}
        <div className="px-8 pb-10 pt-6 md:px-10 flex flex-col gap-6 items-center">
          <p className="text-[#9ea3ab] text-[16px] font-pretendard text-center leading-relaxed">
            フォーム入力は不要です。LINEから直接メッセージをお送りいただければ、すぐに対応いたします。
          </p>
          ...
          <a 
            ...
            className="w-full flex items-center justify-center gap-3 h-[65px] rounded-xl bg-[#06C755] text-white hover:bg-[#05b34c] transition-all transform hover:scale-[1.02] shadow-sm font-pretendard text-[20px] font-medium"
          >
            {/* LINE Official Icon Vector */}
