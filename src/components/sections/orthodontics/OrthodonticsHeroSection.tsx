 ...
 * 치아교정 히어로 섹션 컴포넌트 (데모)
 */
export function OrthodonticsHeroSection() {
        ...
        <Container className="relative h-full">
          <div className="relative h-full flex flex-col md:flex-row items-center md:items-end justify-end md:justify-between pb-[87px] md:pb-[114px] gap-[27px]">
            <div className={cn("flex flex-col", "z-10")}>
              ...
              >
                {isEn ? <>Beyond teeth,<br />life-changing orthodontics</> : <>치아를 넘어,<br />인생을 바꾸는 치아교정</>}
              </h2>
            </div>
            <div className="z-20">
              <HeroConsultationButton label={isEn ? "Book Consultation" : "상담하기"} />
            </div>
          </div>
        </Container>
      </div>
