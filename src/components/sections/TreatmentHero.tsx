          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className={`w-full flex flex-col ${isSplitLayout ? 'md:flex-row md:justify-between md:items-end gap-10' : 'items-start gap-6'}`}>
                {title && (
                  <h1 className={`${titleSize || 'text-[42px] md:text-[48px]'} font-sans font-bold tracking-tighter leading-[1.1] uppercase whitespace-pre-line text-pretty ${isSplitLayout ? 'md:text-left flex-1' : ''}`}>
