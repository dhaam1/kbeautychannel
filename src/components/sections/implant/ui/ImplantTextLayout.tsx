...
interface ImplantTextLayoutProps {
  text: string;
...
export function ImplantTextLayout({
  text,
  subtitle,
  className,
  color = "#FFF",
}: ImplantTextLayoutProps) {
  return (
    <div className={cn("flex flex-col", className)}>
      ...
      <div className="flex flex-row items-center justify-center gap-3 pb-[10px] md:justify-start md:pb-5">
        ...
        {/* 텍스트 */}
        <h1
          className="text-[20px] tracking-[-0.16px]"
          style={{
            color: color,
            fontStyle: "normal",
            fontWeight: 400,
      ...
      {/* 2행: 서브텍스트 */}
      <h2
        className="text-center md:text-left text-[24px] tracking-[-0.24px] font-semibold md:text-[28px] md:font-normal md:tracking-[-0.28px] subtitle-hero whitespace-pre-wrap"
        style={{
          color: color,
          fontStyle: "normal",
          lineHeight: "normal",
