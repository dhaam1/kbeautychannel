...
/**
 * 임플란트 CTA 섹션
 * 배경색과 텍스트 색상을 반대로 변경한 버전
 */
export function ImplantCTASection() {
    const t = useTranslations('implant.ctaSection');
    const locale = useLocale();
    const isJp = locale === 'jp';

    return (
        <div className="relative w-full overflow-hidden flex-shrink-0" style={{ backgroundColor: '#F7F8F8' }}>
            <div className="flex flex-col items-center text-center w-full pt-[40px] pb-[60px] md:pb-[100px]" style={{ backgroundColor: '#F7F8F8' }}>
                <p
                    className={`pb-[97px] relative z-10 whitespace-pre-line text-[28px] md:text-[32px] ${isJp ? 'tracking-[0.02em]' : 'tracking-[-0.28px] md:tracking-[-0.32px]'
                        }`}
                    style={{
                        color: '#000',
                        textAlign: 'center',
                ...
                >
                    ...
                    <span className="hidden md:inline whitespace-pre-line">
                        {isJp ? "植えることより長く保つことが重要です。\nブランシュ歯科は生涯管理する主治医となります。" : t('desktop')}
                    </span>
                </p>
