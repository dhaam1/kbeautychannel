...
export function ImplantCTASectionForm() {
  const locale = useLocale();
  const t = useTranslations('implant');
          ...
          <div className="flex flex-col items-start text-left">
            ...
            <div
              className={cn(
                ...
                "mb-[60px] text-[28px] md:text-[32px] font-[500] tracking-[-0.28px] md:tracking-[-0.32px] whitespace-pre-line"
              )}
